...
scanner = Scanner()
key="AIzaSyA3lCwzyl9wGQ3_0m-JfMryGuLnx-1r1VY" # Insert your Google key here

for place in places:
	searchitems={"name": place, "types": "bakery|bank|bar|bicycle_store|book_store|cafe|clothing_store|convenience_store|department_store|electronics_store|furniture_store|gas_station|grocery_or_supermarket|hardware_store|home_goods_store|jewelry_store|liquor_store|pet_store|pharmacy|restaurant|shoe_store|store"};
	service = GoogleRadarSearch(searchitems, key)
	scanner.set_service(service)
	scanner.start_scanning()